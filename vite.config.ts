...
function figmaSiteConfiguration(config: FigmaSiteConfiguration): Plugin {
  ...
  const title = config.title ?? "WorkplaceHQ | Enterprise Transformation & Career Services"
  ...
  return {
    ...
    transformIndexHtml: {
      order: 'post', // Changed from 'pre' to 'post' so Vite injects compiled JS bundle tags into body
      handler(html) {
        let result = html
 ...
 * the Figma preview script drives directly.
 */
