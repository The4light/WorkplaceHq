...
const programs = [
  ...
  },
  {
    ...
    outcomes: '25â€“40% operational efficiency gains measurable within one quarter.',
    level: 'Advanced',
  },
  {
    ...
    <div style={{ backgroundColor: 'var(--whq-bg)', minHeight: '100vh', fontFamily: 'var(--font-body)' }}>
      <div className="relative pt-32 pb-12 px-6 overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto">
          ...
          <p className="text-lg max-w-xl" style={{ color: '#6B7280' }}>Structured team upskilling modules for the skills that compound â€” AI, operations, leadership, and CX.</p>
        </div>
      </div>
              ...
              <div key={p.title} className="p-7 rounded-2xl flex flex-col gap-5" style={{ backgroundColor: '#FFFFFF', border: '1px solid #E5E1D8' }}>
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {p.modules.map(m => (
                      <span key={m} className="px-2.5 py-1 rounded-md text-xs" style={{ backgroundColor: 'var(--whq-bg)', color: '#111827', border: '1px solid #E5E1D8' }}>{m}</span>
                    ))}
                  </div>
                </div>
