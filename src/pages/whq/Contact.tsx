...
export default function WHQContact() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Send submission payload to central Formspree helper
      const success = await sendFormspreeNotification(
        FORMSPREE_IDS.WORKPLACE_HQ_CONTACT,
        {
    ...
    >
      ...
      <div className="relative pt-32 pb-12 px-6 overflow-hidden">
        ...
        <div className="max-w-[1440px] mx-auto relative z-10">
          ...
          <h1
            className="font-display font-700 text-[clamp(2rem,4vw,3.5rem)] leading-tight mb-4"
            style={{ color: "#111827" }}
          >
            Let's talk about your team.
          </h1>
          <p className="text-lg max-w-2xl" style={{ color: "#6B7280" }}>
            Ready to book a workshop, start training, or just want to know
            what's possible for your team? Reach out — we reply within 24 hours.
          </p>
        </div>
      </div>
        ...
        <div className="max-w-[1440px] mx-auto grid lg:grid-cols-2 gap-10">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <p
                      ...
                      style={{ color: "#0B3C2D" }}
                    >
                      Got it! Someone from our team will be in touch within 24
                      hours.
                    </p>
                    <p className="mt-2 text-sm" style={{ color: "#6B7280" }}>
                      Need to reach us directly? Send your email to{" "}
                      <a
              ...
              <form className="flex flex-col gap-4" onSubmit={handleSubmit}>
                ...
                <select
                  ...
                  style={{
                    ...
                    backgroundColor: "var(--whq-bg)",
                    borderRadius: "8px",
                    color: formData.inquiryType ? "#111827" : "#6B7280",
                  }}
                >
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full py-3.5 rounded-xl font-bold text-xs uppercase tracking-wider transition-all duration-200 border hover:!bg-[#1DA54A] hover:!border-[#1DA54A] hover:!text-[#0B3C2D] flex items-center justify-center gap-2"
                  style={{
          ...
          <div className="flex flex-col gap-6">
            ...
            <div
              ...
              style={{
                backgroundColor: "#0B3C2D",
                border: "1px solid rgba(29,165,74,0.2)",
              }}
            >
              ...
              <div className="relative z-10 flex flex-col gap-3">
                ...
                >
                  All incoming inquiries are routed directly to the appropriate
                  regional practice lead within 24 hours.
                </p>
              </div>
            </div>
          </div>
