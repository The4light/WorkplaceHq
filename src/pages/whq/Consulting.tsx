  ...
  return (
    <div style={{ backgroundColor: 'var(--whq-bg)', minHeight: '100vh', fontFamily: 'var(--font-body)' }}>
      <div className="relative pt-32 pb-12 px-6 overflow-hidden">
        ...
        <div className="pointer-events-none absolute -bottom-24 -left-24 w-[500px] h-[500px] rounded-full" style={{ background: '#1DA54A', filter: 'blur(150px)', opacity: 0.12 }} />
      ...
      <section className="px-6 pb-20">
        <div className="max-w-[1440px] mx-auto">
                ...
                return (
                  <div key={p.phase} className="grid lg:grid-cols-[200px_1fr] gap-6 lg:gap-12 items-start">
                    <div className="flex lg:flex-col items-center lg:items-end gap-4 lg:gap-2 lg:pr-12">
                      <div className="hidden lg:flex w-3 h-3 rounded-full shrink-0 lg:ml-auto" style={{ backgroundColor: '#1DA54A', boxShadow: '0 0 0 4px rgba(29,165,74,0.2)' }} />
                    ...
                    <div className="p-7 rounded-2xl transition-all hover:-translate-y-0.5 duration-200" style={{ backgroundColor: i % 2 === 0 ? '#FFFFFF' : '#0B3C2D', border: `1px solid ${i % 2 === 0 ? '#E5E1D8' : 'rgba(16,185,129,0.2)'}` }}>
                      ...
                      <div className="flex flex-wrap gap-2">
                        {p.deliverables.map(d => (
                          <span key={d} className="px-3 py-1 rounded-full text-xs font-medium" style={{ backgroundColor: i % 2 === 0 ? 'var(--whq-bg)' : 'rgba(255,255,255,0.08)', color: i % 2 === 0 ? '#0B3C2D' : '#10B981', border: `1px solid ${i % 2 === 0 ? '#E5E1D8' : 'rgba(16,185,129,0.3)'}` }}>
                            {d}
                          </span>
                        ))}
                      </div>
          ...
          <div className="mt-12 p-8 rounded-2xl text-center" style={{ backgroundColor: '#0B3C2D' }}>
            ...
            <Link to="/contact" className="inline-flex items-center gap-2 px-6 py-3 rounded-lg font-semibold text-sm" style={{ backgroundColor: '#1DA54A', color: '#0B3C2D', fontFamily: 'var(--font-display)' }}>
