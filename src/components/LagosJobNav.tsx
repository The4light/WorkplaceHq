    ...
    <nav className="w-full bg-[#f4f6f6] border-b border-gray-200/60 px-4 sm:px-6 py-4 relative z-50">
      <div className="max-w-[1440px] mx-auto flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <Link
            to="/"
            className="hidden sm:inline-flex items-center justify-center bg-[#0F2C34] hover:bg-[#163f4b] text-white font-semibold text-xs sm:text-sm px-4 sm:px-5 py-2 sm:py-2.5 rounded-full transition-all duration-150 shadow-sm shrink-0 border border-white/10"
          >
            Go to Workplace
          </Link>
